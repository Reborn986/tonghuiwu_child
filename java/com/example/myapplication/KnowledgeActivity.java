...
//这个是链接到微信公众号的文章，不用管，用不到
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CommonAdapter<Knowledge>(this, R.layout.konwledge_item, dataSource) {
            @Override
    ...
    private void initData() {
        ...
        knowledge7.setImgUrl("https://mmbiz.qpic.cn/sz_mmbiz_jpg/uB1JxZ9GYiagMLyqsAgtpb4ib6ibnJhdYr4chgVoVK7viaqA1ZRC4zKg9JRz2VX3kRZDlua950u1yLoibhibb41wicvTg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1");
        dataSource.add(knowledge7);


        Knowledge knowledge8 = new Knowledge();
        knowledge8.setTitle("色彩的基础理论");
        knowledge8.setSubheading("必备干货：一定要熟知的色彩知识~");
        knowledge8.setUrl("https://mp.weixin.qq.com/s/9VHoTc1KZoYmY4F3PD-keg");
        knowledge8.setImgUrl(" g&wxfrom=5&wx_lazy=1&wx_co=1");
        dataSource.add(knowledge8);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KnowledgeActivity.this, SekaBlue.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KnowledgeActivity.this, society.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
