    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PhotoProcess.this, MainActivity.class);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PhotoProcess.this, SekaBlue.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(switchTheme==1) {
                    intent.setClass(PhotoProcess.this, society.class);
                }
                else if(switchTheme==0){
                    intent.setClass(PhotoProcess.this, Society2.class);
                }
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (value[0] < 1 || value[0] > 6) {
                    FloatingWindowExample.showFloatingWindow(PhotoProcess.this, "只能输入1-6的整数");
                }
                LinearLayout liXuanzeyanse = findViewById(R.id.li_xuanzeyanse);
...
// 创建一个圆角矩形形状
                        ...
                        shape.setCornerRadius(100); // 设置圆角半径
...
// 创建一个描边形状
            ...
            stroke.setCornerRadius(100); // 设置圆角半径
...
// 将 LayerDrawable 设置为 View 的背景
        ...
        //保存色卡////////////////////////////////////////////////////////////////////////
        Button saveButton = findViewById(R.id.b_baocun);
        ...
        //收藏色卡////////////////////////////////////////////////////////////////////////
        Button loveButton = findViewById(R.id.b_love);
    ...
    private void takePhoto() {
        ...
        if (Build.VERSION.SDK_INT >= 24)
            ...
            //把文件转换成Uri对象
                 ...
                 */ {
            imageUri = FileProvider.getUriForFile(PhotoProcess.this,
...
//            rgb.setTextColor(modifiedColor);
    ...
    private void lovePicture(LinearLayout linearLayout) {
        Bitmap bitmap = Bitmap.createBitmap(linearLayout.getWidth(), linearLayout.getHeight(), Bitmap.Config.ARGB_8888);
//        LinearLayout liSave=findViewById(R.id.li_baocundseka);
//        liSave.setVisibility(View.GONE);
        // 创建一个 Canvas 对象，并将其绘制到 Bitmap 上
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(PhotoProcess.this, "收藏成功", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            } catch (IOException e) {
